...
### What is generated, what is hand-authored

The repo carries both generator output and hand-curated design work; the split is explicit
so "thousands of lines of JSON" reads as build product, not maintenance burden:

| Artifact | Provenance | Regenerated by |
|---|---|---|
...
of them on every push and fails on any byte difference - a stale artifact cannot reach `main`.
