...
///
/// Reads `twinDir/tokens.css`'s generated-header first line
/// (`/* GENERATED by utopia_design_tools:generate_twin from <path> - do not edit. */`,
...
/// Matches `generate_twin`'s `tokens.css` header line, capturing the recorded
/// input path:
/// `/* GENERATED by utopia_design_tools:generate_twin from <path> - do not edit. */`.
